...
const { default: importService } =
  await import('../../src/modules/import/services/import.service.js');
...
describe('ImportService', () => {
  ...
  describe('processImportJob', () => {
    it('should process a PDF invoice job successfully', async () => {
      ...
      expect(mockRepo.updateJob).toHaveBeenCalledWith(jobId, tenantId, {
        importStatus: 'PROCESSING',
      });
      expect(mockOcrService.extractInvoiceData).toHaveBeenCalledWith(job.fileUrl);
      expect(mockRepo.createExtractedItem).toHaveBeenCalledWith(
        expect.objectContaining({
