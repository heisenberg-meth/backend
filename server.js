      ...
      if (expiring.length > 0) {
        ...
        await sendEmail(
          ...
          <div style="font-family:Manrope,sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#0A0F1C;border-radius:16px;color:#e0e0e0;">
            ...
            <p style="margin-top:24px;">Log in to your <a href="${process.env.FRONTEND_URL || "https://viyan-medassist.vercel.app"}" style="color:#4fdbc8;">MedAssist Dashboard</a> to take action.</p>
