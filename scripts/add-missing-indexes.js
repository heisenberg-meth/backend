...
const indexesToCreate = [
  // Invoice related
  { table: 'Invoice', columns: ['"tenantId"', '"createdBy"'], name: 'idx_invoice_tenant_createdby' },
  ...
  // StockMovement - Critical for performance
  { table: 'StockMovement', columns: ['"tenantId"', '"medicineId"', '"createdAt"'], name: 'idx_stock_movement_tenant_medicine_date' },
  { table: 'StockMovement', columns: ['"tenantId"', '"batchId"'], name: 'idx_stock_movement_tenant_batch' },
  { table: 'StockMovement', columns: ['"tenantId"', '"branchId"'], name: 'idx_stock_movement_tenant_branch' },
  { table: 'StockMovement', columns: ['"performedBy"'], name: 'idx_stock_movement_performedby' },

  // InventoryBatch - Critical for performance
  { table: 'InventoryBatch', columns: ['"tenantId"', '"medicineId"'], name: 'idx_inventory_batch_tenant_medicine' },
  { table: 'InventoryBatch', columns: ['"tenantId"', '"supplierId"'], name: 'idx_inventory_batch_tenant_supplier' },
  { table: 'InventoryBatch', columns: ['"tenantId"', '"branchId"'], name: 'idx_inventory_batch_tenant_branch' },
  { table: 'InventoryBatch', columns: ['"purchaseInvoiceId"'], name: 'idx_inventory_batch_purchase_invoice' },
  { table: 'InventoryBatch', columns: ['"purchaseOrderItemId"'], name: 'idx_inventory_batch_po_item' },
  ...
  { table: 'SalesReturn', columns: ['"tenantId"', '"createdBy"'], name: 'idx_sales_return_tenant_createdby' },
  ...
  // Supplier related
  { table: 'SupplierPayment', columns: ['"tenantId"', '"supplierId"'], name: 'idx_supplier_payment_tenant_supplier' },
  ...
  { table: 'SupplierReturnItem', columns: ['"medicineId"'], name: 'idx_supplier_return_item_medicine' },

  // Patient related
  { table: 'PatientCreditLedger', columns: ['"accountId"'], name: 'idx_patient_credit_ledger_account' },
  { table: 'PatientIdentityMap', columns: ['"internalPatientId"'], name: 'idx_patient_identity_map_internal' },

  // Notification related
  { table: 'Notification', columns: ['"tenantId"', '"userId"'], name: 'idx_notification_tenant_user' },
  ...
  { table: 'PurchaseOrderItem', columns: ['"medicineId"'], name: 'idx_purchase_order_item_medicine' },
  ...
  // Inventory related
  { table: 'InventoryReconciliation', columns: ['"branchId"'], name: 'idx_inventory_reconciliation_branch' },
  { table: 'InventoryReconciliation', columns: ['"medicineId"'], name: 'idx_inventory_reconciliation_medicine' },
  ...
  { table: 'ExpiryRecommendation', columns: ['"batchId"'], name: 'idx_expiry_recommendation_batch' },
  { table: 'ExpiryRecommendation', columns: ['"tenantId"'], name: 'idx_expiry_recommendation_tenant' },
  { table: 'ExpiryRiskPrediction', columns: ['"batchId"'], name: 'idx_expiry_risk_prediction_batch' },
  { table: 'ExpiryRiskPrediction', columns: ['"branchId"'], name: 'idx_expiry_risk_prediction_branch' },
  { table: 'ExpiryRiskPrediction', columns: ['"medicineId"'], name: 'idx_expiry_risk_prediction_medicine' },

  // Forecast related
  { table: 'DemandForecast', columns: ['"branchId"'], name: 'idx_demand_forecast_branch' },
  { table: 'ForecastRecommendation', columns: ['"tenantId"'], name: 'idx_forecast_recommendation_tenant' },
  ...
  { table: 'MedicineInventoryConfig', columns: ['"updatedBy"'], name: 'idx_medicine_inventory_config_updatedby' },
  { table: 'MedicinePriceHistory', columns: ['"changedBy"'], name: 'idx_medicine_price_history_changedby' },
  { table: 'MedicineStatusHistory', columns: ['"changedBy"'], name: 'idx_medicine_status_history_changedby' },
  { table: 'MedicineSubscription', columns: ['"medicineId"'], name: 'idx_medicine_subscription_medicine' },
  ...
  { table: 'ImportExtractedItem', columns: ['"matchedMedicineId"'], name: 'idx_import_extracted_item_medicine' },
  ...
  { table: 'StockTransferItem', columns: ['"transferId"'], name: 'idx_stock_transfer_item_transfer' },
  { table: 'StockTransfer', columns: ['"sourceBranchId"'], name: 'idx_stock_transfer_source_branch' },
  { table: 'StockTransfer', columns: ['"destinationBranchId"'], name: 'idx_stock_transfer_dest_branch' },
  ...
  { table: 'SettingsApproval', columns: ['"approvedBy"'], name: 'idx_settings_approval_approvedby' },
  { table: 'SettingsApproval', columns: ['"proposedBy"'], name: 'idx_settings_approval_proposedby' },
  ...
  { table: 'InvoiceAuditLog', columns: ['"performedBy"'], name: 'idx_invoice_audit_log_performedby' },
  { table: 'Transaction', columns: ['"userId"'], name: 'idx_transaction_user' },
  { table: 'OtpAuditLog', columns: ['"userId"'], name: 'idx_otp_audit_log_user' },
  { table: 'InpatientMedicationUsage', columns: ['"admissionId"'], name: 'idx_inpatient_medication_admission' },
  { table: 'InpatientMedicationUsage', columns: ['"medicineId"'], name: 'idx_inpatient_medication_medicine' },
  { table: 'PatientAdherence', columns: ['"refillId"'], name: 'idx_patient_adherence_refill' },
  { table: 'PatientRefillReminder', columns: ['"refillId"'], name: 'idx_patient_refill_reminder_refill' },
  { table: 'PatientRefillReminder', columns: ['"tenantId"'], name: 'idx_patient_refill_reminder_tenant' },
  { table: 'PatientReminder', columns: ['"medicineId"'], name: 'idx_patient_reminder_medicine' },
  { table: 'PatientPrescription', columns: ['"tenantId"'], name: 'idx_patient_prescription_tenant' },
