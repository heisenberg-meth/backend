...
class AlertFastifyController {
  async getAll(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-all' }, 'Alert error');
  ...
  async getLowStock(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-low-stock' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
  ...
  async getExpiring(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-expiring' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
  ...
  async getCritical(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-critical' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
  ...
  async getEscalated(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-escalated' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
  ...
  async snooze(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-snooze' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
  ...
  async markOnOrder(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-mark-on-order' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
  ...
  async raisePurchaseOrder(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-raise-po' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
  ...
  async resolve(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-resolve' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
  ...
  async triggerEscalationScan(request, reply) {
    try {
      ...
      request.log.error({ err: error, endpoint: 'alert-trigger-escalation' }, 'Alert error');
      return reply.code(500).send({ success: false, message: error.message });
    }
  }
}
