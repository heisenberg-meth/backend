...
async function alertSettingsRoutes(fastify) {
  ...
  // ── Medicine Threshold Overrides ──
  fastify.get('/alerts/:settingsId/overrides', {
    schema: {
      tags: ['Alert Settings'],
  ...
  fastify.post('/alerts/:settingsId/overrides', {
    schema: {
      tags: ['Alert Settings'],
  ...
  fastify.put('/alerts/overrides/:id', {
    schema: {
      tags: ['Alert Settings'],
  ...
  fastify.delete('/alerts/overrides/:id', {
    schema: {
      tags: ['Alert Settings'],
