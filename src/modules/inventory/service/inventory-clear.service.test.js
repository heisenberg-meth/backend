...
const cacheInvalidatorPath = path.resolve(__dirname, './cache-invalidator.service.js');
const lockPath = path.resolve(__dirname, '../../../shared/utils/lock.js');
const queuePath = path.resolve(__dirname, '../../../queue/index.js');
const inventoryClearServicePath = path.resolve(__dirname, './inventory-clear.service.js');
