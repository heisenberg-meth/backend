...
async function paymentRoutes(fastify) {
  ...
  fastify.get('/:paymentId/timeline', {
    schema: {
      tags: ['Payments'],
  ...
  fastify.get('/reconciliation/history', {
  ...
  fastify.post('/invoices/:id/payment', {
    schema: {
      tags: ['Payments'],
  ...
  // ── Refund Engine ──
  fastify.post('/allocations/:id/refund', {
    schema: {
      tags: ['Payments'],
