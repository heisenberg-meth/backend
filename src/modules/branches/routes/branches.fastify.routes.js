...
async function branchesFastifyRoutes(fastify) {
  ...
  fastify.get(
    '/',
    {
      schema: { tags: ['Branches'], summary: 'List branches' },
  ...
  fastify.get(
    '/inventory/global',
    {
      schema: { tags: ['Branches'], summary: 'Global inventory view' },
      preHandler: [requirePermission('inventory.read')],
    },
    centralInventoryController.getGlobalInventory,
  );
  fastify.get(
    '/inventory/branch/:branchId',
    {
      schema: { tags: ['Branches'], summary: 'Branch inventory view' },
      preHandler: [requirePermission('inventory.read')],
    },
    centralInventoryController.getBranchInventory,
  );
  fastify.get(
    '/transfers',
    {
      schema: { tags: ['Branches'], summary: 'List transfers' },
      preHandler: [requirePermission('inventory.read')],
    },
  ...
  fastify.post(
    '/transfers',
    {
      schema: { tags: ['Branches'], summary: 'Request transfer' },
  ...
  fastify.put(
    ...
    {
      schema: { tags: ['Branches'], summary: 'Approve transfer' },
      preHandler: [requirePermission('settings.manage')],
    },
  ...
  fastify.put(
    ...
    {
      schema: { tags: ['Branches'], summary: 'Receive transfer' },
      preHandler: [requirePermission('inventory.update')],
    },
