...
async function analyticsRoutes(fastify) {
  ...
  fastify.get(
    '/expiry-loss-report',
    {
      schema: {
        tags: ['Analytics'],
        summary: 'Total value of expired stock with supplier shelf-life analysis',
      },
      preHandler: [requirePermission('analytics.read')],
    },
  ...
  fastify.get(
    '/payment-methods',
    {
      schema: {
        tags: ['Analytics'],
        summary: 'Payment method breakdown with fraud-relevant metrics',
      },
      preHandler: [requirePermission('analytics.financial.read')],
    },
  ...
  fastify.get(
    '/branch-performance',
    {
      schema: {
        tags: ['Analytics'],
        summary: 'Branch performance metrics: revenue, profit, turnover, expiry loss per branch',
      },
      preHandler: [requirePermission('analytics.financial.read')],
    },
